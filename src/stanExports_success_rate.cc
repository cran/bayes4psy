...
#include "stanExports_success_rate.h"

RCPP_MODULE(stan_fit4success_rate_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_success_rate")

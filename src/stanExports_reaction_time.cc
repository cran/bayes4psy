...
#include "stanExports_reaction_time.h"

RCPP_MODULE(stan_fit4reaction_time_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_reaction_time")
